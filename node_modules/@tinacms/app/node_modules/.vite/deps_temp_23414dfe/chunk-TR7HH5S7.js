...
var registerDefaultLayoutLoaders = __name(() => {
  registerLayoutLoaders([
    {
      name: "dagre",
      loader: __name(async () => await import("./dagre-BM42HDAG-KW7CLZLJ.js"), "loader")
    },
    ...true ? [
      {
        name: "cose-bilkent",
        loader: __name(async () => await import("./cose-bilkent-S5V4N54A-D56HKSME.js"), "loader")
      }
    ] : []
  ]);
...
//# sourceMappingURL=chunk-TR7HH5S7.js.map
